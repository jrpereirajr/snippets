...
import { PatchService, PatchDisponivel } from './patch.service';
...
fdescribe('PatchService', () => {
  const testUrl = '/shift/bi/baseqabi/api/v1/patch/versoes-disponiveis';
  ...
  it('should return data', () => {
    ...
    httpClient.get<PatchDisponivel[]>(testUrl)
      .subscribe(data => {
